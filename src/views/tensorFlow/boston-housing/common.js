...
export function arraysToTensors() {
  ...
  console.log("bostonData.testTarget is ", bostonData.testTarget);
...
export function multiLayerPerceptronRegressionModel1Hidden() {
  const model = tf.sequential();
  console.log("bostonData is ", bostonData);
  console.log("bostonData.numFeatures is ", bostonData.numFeatures);
  // console.log("bostonData.numFeatures.dataSync() is ", bostonData.numFeatures.data);
  model.add(
    tf.layers.dense({
